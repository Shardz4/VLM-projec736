"""Executable CLI entry point for Step 7: CLEVR Zero-Shot Counting Evaluation.
...
def main():
    print("=" * 70)
    print("Step 7 — Zero-Shot Object Counting Probe (CLEVR)")
    print("=" * 70)
    ...
    print("\nStep 7 probe execution completed successfully!")
